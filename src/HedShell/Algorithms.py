...
hashing_algo_list_  =  " | ".join([a.lower() for a in list(hashing.keys())])
encoding_algo_list_ = " | ".join([a.lower() for a in list(encoding.keys())])

hashing_doc = f"  Hash <InputText> [{ hashing_algo_list_ }]"
